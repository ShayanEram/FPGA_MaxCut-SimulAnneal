...
architecture rtl of maxCut_matrix_ram is 
...
architecture arch of maxCut_matrix is
    component maxCut_matrix_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    maxCut_matrix_ram_U :  component maxCut_matrix_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

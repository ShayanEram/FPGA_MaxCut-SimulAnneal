...
// ==============================================================
#ifndef __maxCut_mul_mul_8sfYi__HH__
#define __maxCut_mul_mul_8sfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxCut_mul_mul_8sfYi) {
    ...
    SC_CTOR(maxCut_mul_mul_8sfYi):  ACMP_smul_su_U ("ACMP_smul_su_U") {

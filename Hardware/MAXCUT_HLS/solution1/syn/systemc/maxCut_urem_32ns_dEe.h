...
// ==============================================================
#ifndef __maxCut_urem_32ns_dEe__HH__
#define __maxCut_urem_32ns_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxCut_urem_32ns_dEe) {
    ...
    SC_CTOR(maxCut_urem_32ns_dEe):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {

...
// ==============================================================
#ifndef __maxCut_urem_29ns_cud__HH__
#define __maxCut_urem_29ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxCut_urem_29ns_cud) {
    ...
    ACMP_urem_seq<ID, 33, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(maxCut_urem_29ns_cud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {

...
// ==============================================================
#ifndef __maxCut_sdiv_21ns_dEe__HH__
#define __maxCut_sdiv_21ns_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxCut_sdiv_21ns_dEe) {
    ...
    ACMP_sdiv_seq<ID, 25, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(maxCut_sdiv_21ns_dEe):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

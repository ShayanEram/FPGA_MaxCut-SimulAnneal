...
// ==============================================================
#ifndef __maxCut_sdiv_32ns_eOg__HH__
#define __maxCut_sdiv_32ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxCut_sdiv_32ns_eOg) {
    ...
    SC_CTOR(maxCut_sdiv_32ns_eOg):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

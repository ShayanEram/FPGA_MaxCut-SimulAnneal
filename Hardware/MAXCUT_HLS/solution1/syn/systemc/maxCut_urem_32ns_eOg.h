...
// ==============================================================
#ifndef __maxCut_urem_32ns_eOg__HH__
#define __maxCut_urem_32ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxCut_urem_32ns_eOg) {
    ...
    SC_CTOR(maxCut_urem_32ns_eOg):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
